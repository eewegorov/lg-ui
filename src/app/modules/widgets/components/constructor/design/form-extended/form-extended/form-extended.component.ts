...
export class FormExtendedComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(private utilsService: UtilsService, private widgetConstructorService: WidgetConstructorService) {}
  ...
  ngOnChanges(): void {
    if (
      ...
      this.widget.guiprops.formExt.model.mainSettings.rgbaInputForm = this.widgetConstructorService
        .hexToRgb(
          this.widget.guiprops.formExt.model.mainSettings.bgInputForm,
          this.widget.guiprops.formExt.model.mainSettings.opacityBgInputForm
        )
  ...
  public addItemToExtForm() {
    ...
    item.widthValue =
      this.widget.guiprops.formExt.model.list[this.widget.guiprops.formExt.model.list.length - 1].widthValue;
    item.widthType =
      this.widget.guiprops.formExt.model.list[this.widget.guiprops.formExt.model.list.length - 1].widthType;
